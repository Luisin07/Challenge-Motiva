  ...
  return (
    <div>
      ...
      <div style={{display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:12, marginBottom:28}}>
        ...
        {/* Card 1 — Violações com alerta integrado */}
        <div style={{
          ...
          <p style={{fontSize:10, fontWeight:700, letterSpacing:1.5, color:'#ffffff66', marginBottom:12, textTransform:'uppercase'}}>
            VIOLAÇÕES IMINENTES
          </p>
          ...
          {dados.violacoes_iminentes > 0 && (
            <div style={{
              ...
              <p style={{fontSize:11, color:'#fca5a5', fontWeight:600, lineHeight:1.4}}>
                Intervenção obrigatória em até 48h para evitar infração ARTESP/ANTT
              </p>
            </div>
          )}
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: (dados.conformidade_geral >= 95 ? '#6ee7b7' : '#fca5a5') + '20',
            pointerEvents:'none'
          }} />
          <p style={{fontSize:10, fontWeight:700, letterSpacing:1.5, color:'#ffffff66', marginBottom:12, textTransform:'uppercase'}}>
            CONFORMIDADE GERAL
            ...
            <div key={i} style={{
              ...
              <div style={{background:bgHeader, borderLeft:`4px solid ${corBorda}`, padding:'18px 20px 14px'}}>
                <div style={{display:'flex', justifyContent:'space-between', alignItems:'flex-start'}}>
                  <div>
                    <p style={{color:'#aaa', fontSize:10, fontWeight:600, letterSpacing:1, marginBottom:3}}>
                      RODOANEL MÁRIO COVAS
                    </p>
                    <p style={{color:'#1a1a2e', fontSize:22, fontWeight:800}}>
                      KM {(t.km/1000).toFixed(1).replace('.','+')}</p>
                  </div>
                  <span style={{background:corBorda+'20', color:corBorda, padding:'4px 10px', borderRadius:7, fontSize:11, fontWeight:700}}>
                    {t.situacao}
                  </span>
                </div>
